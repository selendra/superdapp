...
export class IdentityAddSubCall {
   ...
   */
  get isV2015(): boolean {
    return this._chain.getCallHash('Identity.add_sub') === '15f75f81f084f8b5cfd0ccdee06d595fb1595ce645d8bcef5c9e60c866c88ffe'
  }
   ...
   */
  get isV2028(): boolean {
    return this._chain.getCallHash('Identity.add_sub') === '8495390e6499d4c56c6eb611f4e2bd783279971de9a1365c040b4e74a3afb8e9'
  }
...
export class IdentityProvideJudgementCall {
   ...
   */
  get isV1030(): boolean {
    return this._chain.getCallHash('Identity.provide_judgement') === '85abb6ad5428796a496ed72e3d5b4d7233e9bdd8717581236c2676692f561d55'
  }
   ...
   */
  get isV1050(): boolean {
    return this._chain.getCallHash('Identity.provide_judgement') === '8e29b8e88a5ec508d0ed3e9388ac630db50943ae45e818f3b8f8a90993efeef0'
  }
   ...
   */
  get isV2028(): boolean {
    return this._chain.getCallHash('Identity.provide_judgement') === '7af53f4a7f3008c81096b5d06d6c894ad1112da2498e11fe140e75b6cae8bc7e'
  }
...
export class IdentityRenameSubCall {
   ...
   */
  get isV2015(): boolean {
    return this._chain.getCallHash('Identity.rename_sub') === '15f75f81f084f8b5cfd0ccdee06d595fb1595ce645d8bcef5c9e60c866c88ffe'
  }
   ...
   */
  get isV2028(): boolean {
    return this._chain.getCallHash('Identity.rename_sub') === '8495390e6499d4c56c6eb611f4e2bd783279971de9a1365c040b4e74a3afb8e9'
  }
...
export class IdentitySetSubsCall {
   ...
   */
  get isV1030(): boolean {
    return this._chain.getCallHash('Identity.set_subs') === '9b4117bd41c599c686b87d59c5fe5d8bcb3f00a4376d01405e839d252750e862'
  }
   ...
   * # </weight>
   */
  get asV9111(): {subs: [Uint8Array, v9111.Data][]} {
    assert(this.isV9111)
    return this._chain.decodeCall(this.call)
  }
}
