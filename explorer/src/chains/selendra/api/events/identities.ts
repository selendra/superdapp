...
export function getIdentityKilled(ctx: ChainContext, event: Event) {
...
export function getIdentitySubRemoved(ctx: ChainContext, event: Event) {
...
export function getIdentitySubRevoked(ctx: ChainContext, event: Event) {
