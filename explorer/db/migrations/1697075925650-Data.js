module.exports = class Data1697075925650 {
    name = 'Data1697075925650'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token_transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "amount" numeric NOT NULL, "type" character varying(7) NOT NULL, "success" boolean NOT NULL, "extrinsic_id" character varying, "from_id" character varying, "to_id" character varying, CONSTRAINT "PK_77384b7f5874553f012eba9da41" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE INDEX "IDX_b97cf9c4b329a45e7f4353c811" ON "token_transfer" ("extrinsic_id") `)
        ...
        await db.query(`ALTER TABLE "token_transfer" ADD CONSTRAINT "FK_b97cf9c4b329a45e7f4353c8113" FOREIGN KEY ("extrinsic_id") REFERENCES "extrinsic"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_b97cf9c4b329a45e7f4353c811"`)
        ...
        await db.query(`ALTER TABLE "token_transfer" DROP CONSTRAINT "FK_b97cf9c4b329a45e7f4353c8113"`)
