module.exports = class Data1698195144984 {
    name = 'Data1698195144984'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "contract_code" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_extrinsic_hash" text NOT NULL, "removed_at" TIMESTAMP WITH TIME ZONE, "removed_extrinsic_hash" text, "owner_id" character varying, CONSTRAINT "PK_f382f9496f4a282f0f10d804e79" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_1ebc1e0bc39588024886dd9c28" ON "contract_code" ("owner_id") `)
        await db.query(`CREATE TABLE "code_hash_change" ("id" character varying NOT NULL, "new_code_hash" text NOT NULL, "old_code_hash" text NOT NULL, "changed_at" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text NOT NULL, "contract_id" character varying, CONSTRAINT "PK_3fccb352522014fb5cd5544879a" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_cc9820bdaf8e064237bf5d1f56" ON "code_hash_change" ("contract_id") `)
        await db.query(`CREATE TABLE "contract" ("id" character varying NOT NULL, "trie_id" bytea NOT NULL, "terminated_at" TIMESTAMP WITH TIME ZONE, "terminated_extrinsic_hash" text, "storage_info" jsonb NOT NULL, "contract_account_id" character varying NOT NULL, "contract_code_id" character varying, "termination_beneficiary_id" character varying, CONSTRAINT "REL_7e1f9e4455845dc394af86eaee" UNIQUE ("contract_account_id"), CONSTRAINT "PK_17c3a89f58a2997276084e706e8" PRIMARY KEY ("id"))`)
